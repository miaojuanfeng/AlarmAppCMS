...
public class UserDaoImpl implements UserDao {
	...
	public int updateByPrimaryKey(User user) {
		// TODO Auto-generated method stub
		String hql="update User set username=:username, password=:password, nickname=:nickname, platform=:platform, data=:data, modify_date=:modifyDate where deleted=0 and id=:id";
		Query query = getSession().createQuery(hql);
