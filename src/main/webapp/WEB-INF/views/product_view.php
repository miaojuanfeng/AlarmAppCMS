							...
							<div class="fieldset">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-12">
										...
										<div class="form-group">
											<label for="product_price">Price <span class="highlight">*</span></label>
											<div class="input-group">
												<span class="input-group-addon">RMB</span>
												<input id="product_price_rmb" name="product_price_rmb" type="text" class="form-control input-sm required" placeholder="Price RMB" value="<?=$product->product_price_rmb?>" />
											</div>
											<div class="input-group">
												<span class="input-group-addon">HKD</span>
												<input id="product_price_hkd" name="product_price_hkd" type="text" class="form-control input-sm required" placeholder="Price HKD" value="<?=$product->product_price_hkd?>" />
											</div>
											<div class="input-group">
												<span class="input-group-addon">USD</span>
												<input id="product_price_usd" name="product_price_usd" type="text" class="form-control input-sm required" placeholder="Price USD" value="<?=$product->product_price_usd?>" />
											</div>
										</div>
									</div>
									<div class="col-sm-4 col-xs-12">
										...
										<div class="form-group">
											<label for="product_price">Stock Quantity <span class="highlight">*</span></label>
											<?php foreach($warehouses as $key => $value){ ?> 
											<div class="input-group">
												<span class="input-group-addon"><?php echo $value->warehouse_name ?></span>
												<input id="z_stock_product_quantity" name="z_stock_product_quantity[<?php echo $value->warehouse_id; ?>]" type="number" class="form-control input-sm required" placeholder="Quantity" value="<?= isset($product->stock_product_quantity) ? $product->stock_product_quantity[$key] : 0?>" />
											</div>
											<?php } ?>
										</div>
