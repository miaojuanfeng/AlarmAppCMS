        ...
        <div class="row">
          ...
          <div class="content-column-area col-md-12 col-sm-12">
                  ...
                  <table>
                    <tbody>
                      <tr>
                        <td width="90%">
                          <div class="row">
                            <div class="col-sm-2"><h6>Warehouse</h6></div>
                            <div class="col-sm-2">
                              <input type="text" name="warehouse_id" class="form-control input-sm" placeholder="#" value="" />
                            </div>
                            <div class="col-sm-2">
                              <input type="text" name="warehouse_name_like" class="form-control input-sm" placeholder="warehouse name" value="" />
                            </div>
            ...
            <div class="fieldset">
              ...
              <div class="list-area">
                <form name="list" action="<?=base_url('warehouse/delete')?>" method="post">
                  <input type="hidden" name="warehouse_id" />
                  <input type="hidden" name="warehouse_delete_reason" />
                  <div class="page-area">
                  ...
                  <table id="warehouse" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>
                          <a href="<?=get_order_link('warehouse_name')?>">
                            Name <i class="glyphicon glyphicon-sort corpcolor-font"></i>
                          </a>
                        </th>
                        <th>
                          <a href="<?=get_order_link('warehouse_modify')?>">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td title="<?=$value->warehouse_id?>"><?=$key+1?></td>
                        <td><?=ucfirst($value->warehouse_name)?></td>
                        <td><?=convert_datetime_to_date($value->warehouse_modify)?></td>
                        <td class="text-right">
                          <span data-toggle="modal" data-target="#myModal" class="modal-btn" rel="<?=$value->warehouse_id?>">
                        ...
                        <td class="text-right">
                          <a href="<?=base_url('warehouse/update/warehouse_id/'.$value->warehouse_id)?>" data-toggle="tooltip" title="Update">
                            <i class="glyphicon glyphicon-edit"></i>
                          </a>
                        </td>
                        <td class="text-right">
                          <a href="<?=base_url('warehouse/update')?>" data-toggle="tooltip" title="Remove">
