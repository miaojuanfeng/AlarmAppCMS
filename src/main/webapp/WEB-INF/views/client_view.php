							...
							<div class="fieldset">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-12">
										...
										<!-- <p class="form-group">
											<label for="client_terms_id">Payment terms</label>
											<select id="client_terms_id" name="client_terms_id" data-placeholder="Payment terms" class="chosen-select">
												<option value></option>
												<?php
									...
									<table id="client" class="table table-striped table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-right">
													<a href="<?=base_url('client/update')?>" data-toggle="tooltip" title="Remove">
