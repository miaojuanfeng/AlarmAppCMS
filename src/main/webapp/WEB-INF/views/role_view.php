							...
							<div class="fieldset">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-12">
										...
										<p class="form-group">
											<label for="role_warehouse_id">Default Warehouse <span class="highlight">*</span></label>
											<select id="role_warehouse_id" name="role_warehouse_id" data-placeholder="Default Warehouse" class="chosen-select">
												<option value="0"></option>
												<?php
												foreach($warehouses as $key => $value){
													$selected = ($role->role_warehouse_id == $value->warehouse_id) ? 'selected' : ''; ?>
												<option value="<?=$value->warehouse_id?>" <?=$selected?>><?=$value->warehouse_name?></option>
												<?php } ?>
											</select>
										</p>
									...
									<table class="table table-striped table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-right">
													<a onclick="check_delete(<?=$value->role_id?>);" data-toggle="tooltip" title="Remove" class="<?=check_permission('role_delete', 'disable')?>">
