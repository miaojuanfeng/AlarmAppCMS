		...
		<div class="content-area">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-sm-12">
						<form:form name="update" method="post" modelAttribute="discuss">
							...
							<div class="fieldset">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-12">
										...
										<p class="form-group">
											<label for="title">Title <span class="highlight">*</span></label>
										...
										<div class="form-group">
											...
											<form:textarea id="content" path="content" type="text" class="form-control input-sm required" placeholder="Content" />
										</div>
									</div>
									<div class="col-sm-4 col-xs-12">
						...
						<div class="fieldset">
							...
							<div class="list-area">
								<form name="list" action="<c:url value="/cms/${classLower}/delete"></c:url>" method="post">
									<input type="hidden" name="discuss_id" />
										...
										<thead>
											<tr>
												...
												<th>
													<a href="
														<c:choose>
															<c:when test="${order == 'title' && ascend == 'asc'}">
																<c:url value="/cms/${classLower}/select/order/title/ascend/desc/1"></c:url>
															</c:when>
															<c:otherwise>
																<c:url value="/cms/${classLower}/select/order/title/ascend/asc/1"></c:url>
															</c:otherwise>
														</c:choose>
													">
