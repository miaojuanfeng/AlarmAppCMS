							...
							<div class="fieldset">
								<div class="row">
									...
									<div class="col-sm-4 col-xs-12">
										...
										<p class="form-group">
											<label for="vendor_name">Name <span class="highlight">*</span></label>
											<input id="vendor_name" name="vendor_name" type="text" class="form-control input-sm required" placeholder="Name" value="<?=$vendor->vendor_name?>" />
										</p>
									</div>
									<div class="col-sm-4 col-xs-12">
											...
											<tr>
												<td width="90%">
													<div class="row">
														...
														<div class="col-sm-2">
															<input type="text" name="vendor_name_like" class="form-control input-sm" placeholder="Vendor name" value="" />
														</div>
									...
									<table id="vendor" class="table table-striped table-bordered">
										<thead>
											<tr>
												<th>#</th>
												<th>
													<a href="<?=get_order_link('vendor_name')?>">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-right">
													<span data-toggle="modal" data-target="#myModal" class="modal-btn" rel="<?=$value->vendor_id?>">
												...
												<td class="text-right">
													<a href="<?=base_url('vendor/update')?>" data-toggle="tooltip" title="Remove">
